...
<div class="widget widget-table">
	<form action="<?php echo (isset($form_action)) ? $form_action:''?>" method="post">
		<div class="widget-header form-search force-top">
			...
			<?php if (!empty($buscar)): ?>
				<a href="/laboratorios" class="btn btn-small"><i class="icon-undo"></i> Limpiar Filtro</a>
			<?php endif ?>
			
			<a href="/laboratorios/agregar" class="btn btn-small btn-success btn-right"><i class="icon-plus"></i> Agregar</a> &nbsp;
		</div>
			...
			<table class="table table-striped table-bordered">
				...
				<?php foreach ($query->result() as $row): ?>
					<tr>
						...
						<td align="center">
							<div class="btn-group">
								<a href="/laboratorios/editar/<?php echo $row->id; ?>" class="btn btn-small" title="editar"><i class="icon-pencil"></i></a>
								<a href="/laboratorios/eliminar/<?php echo $row->id; ?>" class="btn btn-small btn-danger" title="eliminar"><i class="icon-remove"></i></a>
							</div>
						</td>
					</tr>
				...
				<?php if ($query->num_rows() == 0): ?>
					<tr>
						<td colspan="4" class="center">No se encontraron resultados</td>
					</tr>
