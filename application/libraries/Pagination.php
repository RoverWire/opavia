...
class Pagination {
	...
	function create_links()
	{
		...
		if ($this->cur_page > 1)
		{
			...
			$pagination.= "<span class=7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;disabled7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;>".$this->first_link."</span>";
		...
		if ($this->cur_page > 1)
		{
			...
			$pagination.= "<span class=7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;disabled7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;>&lt;</span>";
		...
		if ($num_pages < 7 + ($this->num_links * 2))    //not enough pages to bother breaking it up
		{
			for ($counter = 1; $counter <= $num_pages; $counter++)
			{
				...
				{
					$pagination .= "<span class=7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;current7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;>$counter</span>"; // Current page
				}
				else
				{
		...
		elseif($num_pages > 5 + ($this->num_links * 2))    //enough pages to hide some
		{
			...
			elseif($num_pages - ($this->num_links * 2) > $this->cur_page && $this->cur_page > ($this->num_links * 2))
			{
				...
				for ($counter = $this->cur_page - $this->num_links; $counter <= $this->cur_page + $this->num_links; $counter++)
				{
					if ($counter == $this->cur_page)
					{
						$pagination.= "<span class=7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;current7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;>$counter</span>";
					}
					else
					{
						$pagination .= $this->num_tag_open.'<a >base_url.$counter.'">'.$counter.'</a>'.$this->num_tag_close;
		...
		if ($this->cur_page < $counter - 1)
		{
			...
			$pagination.= "<span class=7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;disabled7b6de60ce25fb09baaaf3afbc8b547fc1d0d18f6quot;>".$this->last_link."</span>";
